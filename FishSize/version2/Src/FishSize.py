...
from Src.utils.utils import IncrementPath, IMAGE_FORMATS, VIDEO_FORMATS
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./Src/Models/Custom/pose_nano.pt', help='모델 가중치 파일 경로')
